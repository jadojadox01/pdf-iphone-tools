...
const PRIVACY = [
  "The file is processed in this browser tab. It is not uploaded to our servers for conversion.",
...
export const TOOL_EXPLAIN = {
  ...
  "protect-pdf": {
    ...
    happens: happens("The PDF is encrypted in this tab. The password is not sent to our servers."),
    example: {
      title: "Example",
