...
export function toToolError(error) {
  ...
  if (/password is incorrect|incorrect password/i.test(message)) {
  ...
  return new ToolError(
    ...
    "The file may be damaged, too complex, or too large for this browser. Try a smaller file or a different PDF.",
  );
}
