...
export async function convertPdfToWord(file, options = {}, onStatus) {
  ...
  assertExtractableText(extracted, "create a Word document");
  ...
  return {
    ...
    meta: {
      ...
      note: "Text was extracted from a text-based PDF. Complex layouts may not match the original page design.",
    },
  };
}
