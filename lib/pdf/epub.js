...
import { extractPdfText, assertExtractableText } from "./text";
...
export async function convertPdfToEpub(file, options = {}, onStatus) {
  ...
  assertExtractableText(extracted, "create an eBook");
...
<package xmlns="http://www.idpf.org/2007/opf" unique-identifier="bookid" version="3.0">
  <metadata xmlns:dc="http://purl.org/dc/elements/1.1/">
    <dc:identifier id="bookid">pdf-iphone-tools-${Date.now()}</dc:identifier>
...
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:epub="http://www.idpf.org/2007/ops">
  ...
  return {
    ...
    meta: {
      ...
      note: "This EPUB contains extracted text in reading order. It is not a pixel-perfect copy of the PDF layout.",
    },
  };
}
