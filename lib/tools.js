...
const tools = [
  ...
  },
  {
    ...
    afterUpload: "Pages are rendered in this browser tab. Nothing is uploaded for conversion.",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "No. Rendering runs in your browser.",
      },
    ],
  },
  {
    ...
    afterUpload: "The Word file is read in this tab and turned into a PDF. It is not uploaded for conversion.",
    ...
    pickerHint: "DOCX files up to 25 MB. Processed in your browser — nothing is uploaded to our servers.",
  ...
  },
  {
    ...
    afterUpload: "Images are placed on PDF pages in this browser. They are not uploaded for conversion.",
    cta: "Create PDF",
    icon: "image",
    outputExt: "pdf",
    outputLabel: "PDF",
    ...
    faqs: [
      ...
      {
        q: "Are files uploaded?",
        a: "No. The PDF is built in your browser.",
      },
    ],
  },
  {
    ...
    afterUpload: "Images are converted in this tab. They are not uploaded.",
    cta: "Convert to JPG",
    icon: "image",
    outputExt: "jpg",
    outputLabel: "JPG image",
  ...
  },
  {
    ...
    afterUpload: "The photo is converted in this browser. It is not uploaded.",
    ...
    faqs: [
      ...
      {
        q: "Are files uploaded?",
        a: "No. Conversion runs in your browser. Safari on iPhone can often read HEIC directly.",
      },
    ],
  },
  {
    ...
    afterUpload: "The PDF is read in this tab. Embedded images are exported. The file is not uploaded.",
    cta: "Extract images",
    icon: "image",
    outputExt: "png",
    ...
    faqs: [
      ...
      {
        q: "Are files uploaded?",
        a: "No. Extraction runs in your browser.",
      },
    ],
  },
  {
