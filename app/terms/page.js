...
export default function TermsPage() {
  return (
    <div className="wrap prose" style={{ padding: "32px 0 64px" }}>
      ...
      <h2>Your files</h2>
      <p>
        You keep ownership of files you process. Conversion happens in your browser. This site does
        not host the PDFs you convert and does not keep copies of them.
      </p>
      <p>
      ...
      <p>
        ...
        files, or non-English text. Check every download before you rely on it. {SITE_NAME} does
        not guarantee conversion quality, OCR accuracy, or that a file can be recovered.
      </p>
